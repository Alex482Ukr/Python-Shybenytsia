...
'друг', 'оче', 'питання', 'будинок', 'сторона', 'країна', 'світ', 'випадок', 'голова', 'дитина', 'сила', 'кінець',
...
'порядок', 'момент', 'театр', 'лист', 'ранок', 'допомога', 'ситуація', 'роль', 'рубль', 'сенс', 'стан',
...
'центр', 'відповідь', 'чоловік', 'автор', 'стіна', 'інтерес', 'федерація', 'правило', 'управління', 'чоловік',
...
'палець', 'досвід', 'служба', 'доля', 'дівчина', 'черга', 'ліс', 'склад', 'член', 'кількість', 'подія',
...
'команда', 'союз', 'лікар', 'договір', 'дерево', 'факт', 'господар', 'природа', 'кут', 'телефон', 'позиція',
'двір', 'письменник', 'літак', 'обсяг', 'рід', 'сонце', 'віра', 'берег', 'вистава', 'фірма', 'способ',
'завод', 'колір', 'журнал', 'керівник', 'фахівець', 'оцінка', 'регіон', 'пісня', 'відсоток', 'батько',
...
'особливість','показник', 'корабель', 'звук', 'враження', 'приватність', 'дитинство', 'висновок', 'професор',
'частка', 'норма', 'минуле', 'командир', 'коридор', 'підтримка', 'рамка', 'ворог', 'етап', 'чорт', 'дід',
...
'зима', 'десяток', 'глибина', 'мережа', 'студент', 'секунда', 'швидкість', 'пошук', 'сутність', 'податок', 'помилка',
...
'жаль', 'заступник', 'ресурс', 'акція', 'народження', 'адміністрація', 'вартість', 'усмішка', 'артист',
'сусід', 'фраза', 'фігура', "суб'єкт", 'реакція', 'список', 'фотографія', 'журналіст', 'травень', 'порушення',
...
'крісло', 'хворий', 'поїзд', 'університет', 'традиція', 'адреса', 'грудень', 'долоня', 'зведення', 'квітка',
'лідер', 'жовтень', 'заняття', 'вересень', 'приміщення', 'січень', 'глядач', 'редакція', 'стиль', 'весна',
'фактор', 'серпень', 'відомість', 'залежність', 'охорона', 'обладнання', 'концерт', 'відділення', 'витрата',
...
'квиток', 'подарунок', "в'язниця", 'ящик', 'конкурс', 'книжка', 'вивчення', 'прохання', 'цар', 'публіка', 'сміх',
'повідомлення', 'загроза', 'біда', 'блок', 'досягнення', 'призначення', 'реклама', 'портрет', 'олія', 'стакан',
'урок', 'годинник', 'крик', 'творчість', 'телевізор', 'інструмент', 'концепція', 'лейтенант', 'екран', 'дно',
'реальність', 'канал', "м'ясо", 'знайомий', 'щока', 'конфлікт', 'переговори', 'запис', 'вагон', 'майданчик',
...
'ракета', 'серія', 'шкачка', 'вершина', 'випуск', 'кулак', 'лід', 'торгівля', 'нафта', 'молодь', 'цифра',
...
'шлюб', 'величина', 'записка', 'ініціатива', 'совість', 'активність', 'кістка', 'спорт', 'кредит', 'господь',
'майор', 'конференція', 'стеля', 'бібліотека', 'помічник', 'конструкція', 'відпочинок', 'ручка', 'метал',
